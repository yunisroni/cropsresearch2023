---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Riau"
...
```{r}
JagungRiau <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "RIAU")
JagungRiau
...
train_data_index_lp <- createDataPartition(JagungRiau$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungRiau[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungRiau[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungRiau$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungRiau[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungRiau[-train_data_index_pr,]
test_data_pr
```
