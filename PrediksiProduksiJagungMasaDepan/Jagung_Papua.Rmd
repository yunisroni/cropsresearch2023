---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Papua"
...
```{r}
JagungPapua <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "PAPUA")
JagungPapua
...
train_data_index_lp <- createDataPartition(JagungPapua$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungPapua[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungPapua[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungPapua$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungPapua[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungPapua[-train_data_index_pr,]
test_data_pr
```
