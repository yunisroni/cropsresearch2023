---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Jawa Barat"
...
```{r}
JagungJawaBarat <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "JAWA BARAT")
JagungJawaBarat
...
train_data_index_lp <- createDataPartition(JagungJawaBarat$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungJawaBarat[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungJawaBarat[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungJawaBarat$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungJawaBarat[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungJawaBarat[-train_data_index_pr,]
test_data_pr
```
