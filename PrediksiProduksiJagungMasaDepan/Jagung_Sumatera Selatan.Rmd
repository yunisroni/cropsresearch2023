...
```{r}
JagungSumateraSelatan <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "SUMATERA SELATAN")
JagungSumateraSelatan
...
train_data_index_lp <- createDataPartition(JagungSumateraSelatan$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungSumateraSelatan[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungSumateraSelatan[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungSumateraSelatan$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungSumateraSelatan[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungSumateraSelatan[-train_data_index_pr,]
test_data_pr
```
