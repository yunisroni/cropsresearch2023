---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - DI Yogyakarta"
...
```{r}
JagungDIYogyakarta <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "DI YOGYAKARTA")
JagungDIYogyakarta
...
train_data_index_lp <- createDataPartition(JagungDIYogyakarta$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungDIYogyakarta[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungDIYogyakarta[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungDIYogyakarta$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungDIYogyakarta[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungDIYogyakarta[-train_data_index_pr,]
test_data_pr
```
