---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Kep. Bangka
  Belitung"
...
```{r}
JagungKepBangkaBelitung <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "KEP. BANGKA BELITUNG")
JagungKepBangkaBelitung
...
train_data_index_lp <- createDataPartition(JagungKepBangkaBelitung$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungKepBangkaBelitung[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungKepBangkaBelitung[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungKepBangkaBelitung$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungKepBangkaBelitung[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungKepBangkaBelitung[-train_data_index_pr,]
test_data_pr
```
