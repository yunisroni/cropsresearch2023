---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Jawa Timur"
...
```{r}
JagungJawaTimur <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "JAWA TIMUR")
JagungJawaTimur
...
train_data_index_lp <- createDataPartition(JagungJawaTimur$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungJawaTimur[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungJawaTimur[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungJawaTimur$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungJawaTimur[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungJawaTimur[-train_data_index_pr,]
test_data_pr
```
