---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Maluku Utara"
...
```{r}
JagungMalukuUtara <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "MALUKU UTARA")
JagungMalukuUtara
...
train_data_index_lp <- createDataPartition(JagungMalukuUtara$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungMalukuUtara[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungMalukuUtara[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungMalukuUtara$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungMalukuUtara[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungMalukuUtara[-train_data_index_pr,]
test_data_pr
```
