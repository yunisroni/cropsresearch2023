...
```{r}
JagungNusaTenggaraTimur <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "NUSA TENGGARA TIMUR")
JagungNusaTenggaraTimur
...
train_data_index_lp <- createDataPartition(JagungNusaTenggaraTimur$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungNusaTenggaraTimur[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungNusaTenggaraTimur[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungNusaTenggaraTimur$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungNusaTenggaraTimur[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungNusaTenggaraTimur[-train_data_index_pr,]
test_data_pr
```
