...
```{r}
JagungSumut <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "SUMATERA UTARA")
JagungSumut
...
train_data_index_lp <- createDataPartition(JagungSumut$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungSumut[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungSumut[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungSumut$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungSumut[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungSumut[-train_data_index_pr,]
test_data_pr
```
