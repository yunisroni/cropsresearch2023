---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Kalimantan
  Selatan"
...
```{r}
JagungKalimantanSelatan <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "KALIMANTAN SELATAN")
JagungKalimantanSelatan
...
train_data_index_lp <- createDataPartition(JagungKalimantanSelatan$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungKalimantanSelatan[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungKalimantanSelatan[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungKalimantanSelatan$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungKalimantanSelatan[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungKalimantanSelatan[-train_data_index_pr,]
test_data_pr
```
