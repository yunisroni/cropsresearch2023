---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Kep Riau"
...
```{r}
JagungKepRiau <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "KEP. RIAU")
JagungKepRiau
...
train_data_index_lp <- createDataPartition(JagungKepRiau$Luas_Panen, p=0.6, list = FALSE)
train_data_lp <- JagungKepRiau[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungKepRiau[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungKepRiau$Produktivitas, p=0.6, list = FALSE)
train_data_pr <- JagungKepRiau[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungKepRiau[-train_data_index_pr,]
test_data_pr
```
