---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Sulawesi
  Tenggara"
...
```{r}
JagungSulawesiTenggara <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "SULAWESI TENGGARA")
JagungSulawesiTenggara
...
train_data_index_lp <- createDataPartition(JagungSulawesiTenggara$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungSulawesiTenggara[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungSulawesiTenggara[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungSulawesiTenggara$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungSulawesiTenggara[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungSulawesiTenggara[-train_data_index_pr,]
test_data_pr
```
...
```{r}
# Melakukan Prediksi untuk produksi 10 tahun ke depan
future_prophet_ts_pr <- make_future_dataframe(prophet_ts_pr, periods = 365*11)
