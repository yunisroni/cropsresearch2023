...
```{r}
JagungSulawesiSelatan <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "SULAWESI SELATAN")
JagungSulawesiSelatan
...
train_data_index_lp <- createDataPartition(JagungSulawesiSelatan$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungSulawesiSelatan[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungSulawesiSelatan[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungSulawesiSelatan$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungSulawesiSelatan[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungSulawesiSelatan[-train_data_index_pr,]
test_data_pr
```
