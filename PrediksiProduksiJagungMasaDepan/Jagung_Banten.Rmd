---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Banten"
...
```{r}
JagungBanten <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "BANTEN")
JagungBanten
...
train_data_index_lp <- createDataPartition(JagungBanten$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungBanten[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungBanten[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungBanten$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungBanten[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungBanten[-train_data_index_pr,]
test_data_pr
```
