---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Bali"
...
```{r}
JagungBali <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "BALI")
JagungBali
...
train_data_index_lp <- createDataPartition(JagungBali$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungBali[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungBali[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungBali$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungBali[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungBali[-train_data_index_pr,]
test_data_pr
```
