---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Nusa Tenggara
  Barat"
...
```{r}
JagungNusaTenggaraBarat <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "NUSA TENGGARA BARAT")
JagungNusaTenggaraBarat
...
train_data_index_lp <- createDataPartition(JagungNusaTenggaraBarat$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungNusaTenggaraBarat[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungNusaTenggaraBarat[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungNusaTenggaraBarat$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungNusaTenggaraBarat[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungNusaTenggaraBarat[-train_data_index_pr,]
test_data_pr
```
