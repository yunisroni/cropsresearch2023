...
```{r}
JagungSulawesiBarat <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "SULAWESI BARAT")
JagungSulawesiBarat
...
train_data_index_lp <- createDataPartition(JagungSulawesiBarat$Luas_Panen, p=0.6, list = FALSE)
train_data_lp <- JagungSulawesiBarat[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungSulawesiBarat[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungSulawesiBarat$Produktivitas, p=0.6, list = FALSE)
train_data_pr <- JagungSulawesiBarat[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungSulawesiBarat[-train_data_index_pr,]
test_data_pr
```
