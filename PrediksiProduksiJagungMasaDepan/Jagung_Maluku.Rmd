---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Maluku"
...
```{r}
JagungMaluku <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "MALUKU")
JagungMaluku
...
train_data_index_lp <- createDataPartition(JagungMaluku$Luas_Panen, p=0.6, list = FALSE)
train_data_lp <- JagungMaluku[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungMaluku[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungMaluku$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungMaluku[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungMaluku[-train_data_index_pr,]
test_data_pr
```
