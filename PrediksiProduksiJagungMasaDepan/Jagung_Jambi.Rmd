---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Jambi"
...
```{r}
JagungJambi <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "JAMBI")
JagungJambi
...
train_data_index_lp <- createDataPartition(JagungJambi$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungJambi[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungJambi[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungJambi$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungJambi[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungJambi[-train_data_index_pr,]
test_data_pr
```
