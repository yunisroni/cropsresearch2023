---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Gorontalo"
...
```{r}
JagungGorontalo <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "GORONTALO")
JagungGorontalo
...
train_data_index_lp <- createDataPartition(JagungGorontalo$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungGorontalo[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungGorontalo[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungGorontalo$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungGorontalo[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungGorontalo[-train_data_index_pr,]
test_data_pr
```
