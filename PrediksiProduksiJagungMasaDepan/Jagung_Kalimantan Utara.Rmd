...
```{r}
JagungKalimantanUtara <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "KALIMANTAN UTARA")
JagungKalimantanUtara
...
train_data_index_lp <- createDataPartition(JagungKalimantanUtara$Luas_Panen, p=0.5, list = FALSE)
train_data_lp <- JagungKalimantanUtara[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungKalimantanUtara[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungKalimantanUtara$Produktivitas, p=0.5, list = FALSE)
train_data_pr <- JagungKalimantanUtara[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungKalimantanUtara[-train_data_index_pr,]
test_data_pr
```
