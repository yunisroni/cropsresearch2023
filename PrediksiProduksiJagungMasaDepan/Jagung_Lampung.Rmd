---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Lampung"
...
```{r}
JagungLampung <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "LAMPUNG")
JagungLampung
...
train_data_index_lp <- createDataPartition(JagungLampung$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungLampung[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungLampung[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungLampung$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungLampung[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungLampung[-train_data_index_pr,]
test_data_pr
```
