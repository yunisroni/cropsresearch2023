...
```{r}
JagungSumateraBarat <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "SUMATERA BARAT")
JagungSumateraBarat
...
train_data_index_lp <- createDataPartition(JagungSumateraBarat$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungSumateraBarat[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungSumateraBarat[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungSumateraBarat$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungSumateraBarat[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungSumateraBarat[-train_data_index_pr,]
test_data_pr
```
...
# Buat data frame
average_pr_df <- data.frame(Tahun = c(2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025), LuasPanen = c(average_yhat_2016_pr, average_yhat_2017_pr,average_yhat_2018_pr,average_yhat_2019_pr, average_yhat_2020_pr, average_yhat_2021_pr, average_yhat_2022_pr, average_yhat_2023_pr, average_yhat_2024_pr, average_yhat_2025_pr))
