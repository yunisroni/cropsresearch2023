---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Jagung Masa Depan - Papua Barat"
...
```{r}
JagungPapuaBarat <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "PAPUA BARAT")
JagungPapuaBarat
...
train_data_index_lp <- createDataPartition(JagungPapuaBarat$Luas_Panen, p=0.6, list = FALSE)
train_data_lp <- JagungPapuaBarat[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungPapuaBarat[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungPapuaBarat$Produktivitas, p=0.6, list = FALSE)
train_data_pr <- JagungPapuaBarat[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungPapuaBarat[-train_data_index_pr,]
test_data_pr
```
