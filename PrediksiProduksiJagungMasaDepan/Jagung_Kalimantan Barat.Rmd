...
```{r}
JagungKalimantanBarat <- filter(pangan_clean, Jenis_Komoditi == "Jagung", Provinsi == "KALIMANTAN BARAT")
JagungKalimantanBarat
...
train_data_index_lp <- createDataPartition(JagungKalimantanBarat$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- JagungKalimantanBarat[train_data_index_lp,]
train_data_lp
test_data_lp <- JagungKalimantanBarat[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(JagungKalimantanBarat$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- JagungKalimantanBarat[train_data_index_pr,]
train_data_pr
test_data_pr <- JagungKalimantanBarat[-train_data_index_pr,]
test_data_pr
```
