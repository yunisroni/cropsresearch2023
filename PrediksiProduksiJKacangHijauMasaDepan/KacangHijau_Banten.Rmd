---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Kacang Hijau Masa Depan - Banten"
...
```{r}
KacangHijauBanten <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "BANTEN")
KacangHijauBanten
...
train_data_index_lp <- createDataPartition(KacangHijauBanten$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauBanten[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauBanten[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauBanten$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauBanten[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauBanten[-train_data_index_pr,]
test_data_pr
```
