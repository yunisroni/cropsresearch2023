...
train_data_index_lp <- createDataPartition(KacangHijauSulawesiBarat$Luas_Panen, p=0.6, list = FALSE)
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauSulawesiBarat$Produktivitas, p=0.6, list = FALSE)
