...
```{r}
KacangHijauKalimantanBarat <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "KALIMANTAN BARAT")
KacangHijauKalimantanBarat
...
train_data_index_lp <- createDataPartition(KacangHijauKalimantanBarat$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauKalimantanBarat[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauKalimantanBarat[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauKalimantanBarat$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauKalimantanBarat[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauKalimantanBarat[-train_data_index_pr,]
test_data_pr
```
