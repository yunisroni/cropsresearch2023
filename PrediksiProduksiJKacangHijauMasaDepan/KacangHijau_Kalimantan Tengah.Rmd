...
```{r}
KacangHijauKalimantanTengah <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "KALIMANTAN TENGAH")
KacangHijauKalimantanTengah
...
train_data_index_lp <- createDataPartition(KacangHijauKalimantanTengah$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauKalimantanTengah[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauKalimantanTengah[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauKalimantanTengah$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauKalimantanTengah[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauKalimantanTengah[-train_data_index_pr,]
test_data_pr
```
