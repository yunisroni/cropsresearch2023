...
```{r}
KacangHijauSulawesiUtara <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "SULAWESI UTARA")
KacangHijauSulawesiUtara
...
train_data_index_lp <- createDataPartition(KacangHijauSulawesiUtara$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauSulawesiUtara[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauSulawesiUtara[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauSulawesiUtara$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauSulawesiUtara[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauSulawesiUtara[-train_data_index_pr,]
test_data_pr
```
