---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Kacang Hijau Masa Depan - Sulawesi
  Tenggara"
...
```{r}
KacangHijauSulawesiTenggara <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "SULAWESI TENGGARA")
KacangHijauSulawesiTenggara
...
train_data_index_lp <- createDataPartition(KacangHijauSulawesiTenggara$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauSulawesiTenggara[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauSulawesiTenggara[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauSulawesiTenggara$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauSulawesiTenggara[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauSulawesiTenggara[-train_data_index_pr,]
test_data_pr
```
