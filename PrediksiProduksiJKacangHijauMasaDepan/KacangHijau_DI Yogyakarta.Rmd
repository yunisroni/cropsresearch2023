---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Kacang Hijau Masa Depan - DI
  Yogyakarta"
...
```{r}
KacangHijauDIYogyakarta <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "DI YOGYAKARTA")
KacangHijauDIYogyakarta
...
train_data_index_lp <- createDataPartition(KacangHijauDIYogyakarta$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauDIYogyakarta[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauDIYogyakarta[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauDIYogyakarta$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauDIYogyakarta[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauDIYogyakarta[-train_data_index_pr,]
test_data_pr
```
