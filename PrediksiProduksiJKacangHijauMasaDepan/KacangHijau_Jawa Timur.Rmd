...
```{r}
KacangHijauJawaTimur <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "JAWA TIMUR")
KacangHijauJawaTimur
...
train_data_index_lp <- createDataPartition(KacangHijauJawaTimur$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauJawaTimur[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauJawaTimur[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauJawaTimur$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauJawaTimur[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauJawaTimur[-train_data_index_pr,]
test_data_pr
```
