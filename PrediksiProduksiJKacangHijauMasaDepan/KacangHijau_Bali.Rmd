---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Kacang Hijau Masa Depan - Bali"
...
```{r}
KacangHijauBali <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "BALI")
KacangHijauBali
...
train_data_index_lp <- createDataPartition(KacangHijauBali$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauBali[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauBali[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauBali$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauBali[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauBali[-train_data_index_pr,]
test_data_pr
```
