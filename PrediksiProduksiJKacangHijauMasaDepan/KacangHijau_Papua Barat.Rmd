---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Kacang Hijau Masa Depan - Papua
  Barat"
...
```{r}
KacangHijauPapuaBarat <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "PAPUA BARAT")
KacangHijauPapuaBarat
...
train_data_index_lp <- createDataPartition(KacangHijauPapuaBarat$Luas_Panen, p=0.6, list = FALSE)
train_data_lp <- KacangHijauPapuaBarat[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauPapuaBarat[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauPapuaBarat$Produktivitas, p=0.6, list = FALSE)
train_data_pr <- KacangHijauPapuaBarat[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauPapuaBarat[-train_data_index_pr,]
test_data_pr
```
