---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Kacang Hijau Masa Depan - Riau"
...
```{r}
KacangHijauRiau <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "RIAU")
KacangHijauRiau
...
train_data_index_lp <- createDataPartition(KacangHijauRiau$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauRiau[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauRiau[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauRiau$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauRiau[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauRiau[-train_data_index_pr,]
test_data_pr
```
