...
```{r}
KacangHijauKalimantanUtara <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "KALIMANTAN UTARA")
KacangHijauKalimantanUtara
...
train_data_index_lp <- createDataPartition(KacangHijauKalimantanUtara$Luas_Panen, p=0.5, list = FALSE)
train_data_lp <- KacangHijauKalimantanUtara[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauKalimantanUtara[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauKalimantanUtara$Produktivitas, p=0.5, list = FALSE)
train_data_pr <- KacangHijauKalimantanUtara[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauKalimantanUtara[-train_data_index_pr,]
test_data_pr
```
