---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Kacang Hijau Masa Depan - Nusa
  Tenggara Timur"
...
```{r}
KacangHijauNusaTenggaraTimur <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "NUSA TENGGARA TIMUR")
KacangHijauNusaTenggaraTimur
...
train_data_index_lp <- createDataPartition(KacangHijauNusaTenggaraTimur$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauNusaTenggaraTimur[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauNusaTenggaraTimur[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauNusaTenggaraTimur$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauNusaTenggaraTimur[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauNusaTenggaraTimur[-train_data_index_pr,]
test_data_pr
```
