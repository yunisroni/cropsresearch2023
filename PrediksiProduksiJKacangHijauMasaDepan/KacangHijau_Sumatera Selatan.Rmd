---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Kacang Hijau Masa Depan - Sumatera
  Selatan"
...
```{r}
KacangHijauSumateraSelatan <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "SUMATERA SELATAN")
KacangHijauSumateraSelatan
...
train_data_index_lp <- createDataPartition(KacangHijauSumateraSelatan$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauSumateraSelatan[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauSumateraSelatan[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauSumateraSelatan$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauSumateraSelatan[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauSumateraSelatan[-train_data_index_pr,]
test_data_pr
```
