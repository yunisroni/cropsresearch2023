---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Kacang Hijau Masa Depan - Maluku
  Utara"
...
```{r}
KacangHijauMalukuUtara <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "MALUKU UTARA")
KacangHijauMalukuUtara
...
train_data_index_lp <- createDataPartition(KacangHijauMalukuUtara$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauMalukuUtara[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauMalukuUtara[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauMalukuUtara$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauMalukuUtara[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauMalukuUtara[-train_data_index_pr,]
test_data_pr
```
