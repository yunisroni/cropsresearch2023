---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Kacang Hijau Masa Depan - Gorontalo"
...
```{r}
KacangHijauGorontalo <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "GORONTALO")
KacangHijauGorontalo
...
train_data_index_lp <- createDataPartition(KacangHijauGorontalo$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauGorontalo[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauGorontalo[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauGorontalo$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauGorontalo[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauGorontalo[-train_data_index_pr,]
test_data_pr
```
