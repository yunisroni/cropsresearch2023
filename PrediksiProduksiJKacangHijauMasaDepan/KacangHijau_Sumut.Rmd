---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Kacang Hijau Masa Depan - Sumatera Utara"
...
```{r}
KacangHijauSumut <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "SUMATERA UTARA")
KacangHijauSumut
...
train_data_index_lp <- createDataPartition(KacangHijauSumut$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauSumut[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauSumut[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauSumut$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauSumut[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauSumut[-train_data_index_pr,]
test_data_pr
```
