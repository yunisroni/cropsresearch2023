---
title: "Prediksi Variabel Yang Mempengaruhi Produksi Kacang Hijau Masa Depan - Jawa
  Tengah"
...
```{r}
KacangHijauJawaTengah <- filter(pangan_clean, Jenis_Komoditi == "Kacang Hijau", Provinsi == "JAWA TENGAH")
KacangHijauJawaTengah
...
train_data_index_lp <- createDataPartition(KacangHijauJawaTengah$Luas_Panen, p=0.7, list = FALSE)
train_data_lp <- KacangHijauJawaTengah[train_data_index_lp,]
train_data_lp
test_data_lp <- KacangHijauJawaTengah[-train_data_index_lp,]
test_data_lp
```
...
```{r}
# membagi data berdasarkan variabel Produksi
train_data_index_pr <- createDataPartition(KacangHijauJawaTengah$Produktivitas, p=0.7, list = FALSE)
train_data_pr <- KacangHijauJawaTengah[train_data_index_pr,]
train_data_pr
test_data_pr <- KacangHijauJawaTengah[-train_data_index_pr,]
test_data_pr
```
