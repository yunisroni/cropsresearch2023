...
```
Jumlah data : 6,426 Record. Dari 6 variabel terhadap 3 buah variabel dengan data NA'S
...
```
Jumlah data setelah dihapus data NA' menjadi 5,564 baris observasi dengan
6 variabel.
...
```
Perbandingan produksi Padi dalam kurun waktu 1993 - 2015 adalah dari provinsi Jawa Barat yang terbanyak dengan Jumlah Produksi Padi sebesar 283696591 Ton.
