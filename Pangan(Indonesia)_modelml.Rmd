...
Untuk mendukung prediksi dengan Model Random Forest, data harus dirubah kedalam format time series (ts)
```{r}
ts_padi_rf <- ts(data_for_rf, start = c(1993,1), frequency = 1)
head(ts_padi_rf)
```
