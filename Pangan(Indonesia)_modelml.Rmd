...
future_prophet_ts_jg <- make_future_dataframe(prophet_ts_jg, periods = 365*11)
...
forecast_subset <- forecast_ts_jg[forecast_ts_jg$ds >= as.Date("2016-01-01") & forecast_ts_jg$ds <= as.Date("2025-01-01"), ]

# Hanya ambil kolom Tahun dan yhat
forecast_yhat_2016_2025_pd <- forecast_subset[, c("ds", "yhat")]

# Print hasilnya
print(forecast_yhat_2016_2025_pd)
```

```{r}
tail(forecast_yhat_2016_2025_pd,10)
```
```{r}
...
forecast_subset_jg <- forecast_ts_jg[forecast_ts_jg$ds >= as.Date("2016-01-01") & forecast_ts_pd$ds <= as.Date("2025-01-01"), ]
forecast_subset_jg

# Hitung rata-rata yhat per tahun
average_yhat_2016_jg <- mean(forecast_subset_jg$yhat[forecast_subset_jg$ds == as.Date("2016-01-01")])
average_yhat_2017_jg <- mean(forecast_subset_jg$yhat[forecast_subset_jg$ds == as.Date("2017-01-01")])
average_yhat_2018_jg <- mean(forecast_subset_jg$yhat[forecast_subset_jg$ds == as.Date("2018-01-01")])
average_yhat_2019_jg <- mean(forecast_subset_jg$yhat[forecast_subset_jg$ds == as.Date("2019-01-01")])
...
# Buat data frame
average_jg_df <- data.frame(Tahun = c(2016, 2017, 2018, 2019, 2020,2021,2022,2023, 2024,2025), Produksi = c(average_yhat_2016_jg, average_yhat_2017_jg,average_yhat_2018_jg,average_yhat_2019_jg, average_yhat_2020_jg, average_yhat_2021_jg,average_yhat_2022_jg, average_yhat_2023_jg, average_yhat_2024_jg, average_yhat_2025_jg))
