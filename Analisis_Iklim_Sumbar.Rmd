...
Iklim
CurahHujan <- read.csv("dataset/climateserv-statistical - SUMBAR.csv")
CurahHujan
```
...
```{r}
# Membuat model RF
rf_model_KacangKedelai <- randomForest(Produksi ~ Produktivitas + Luas_Panen + Kecepatan_Angin + Kelembapan + Suhu + Tekanan_Udara + Penyinaran_Matahari, data = data_train_KacangKedelai, ntree = 1000)
...
```{r}
# Membuat model SVR
svr_model_KacangKedelai <- svm(Produksi ~ Produktivitas + Luas_Panen + Kecepatan_Angin + Kelembapan + Suhu + Tekanan_Udara + Penyinaran_Matahari, data = data_train_KacangKedelai, kernel = "radial", cost = 1)
...
```{r}
# Membuat model RF
rf_model_KacangTanah <- randomForest(Produksi ~ Produktivitas + Luas_Panen + Kecepatan_Angin + Kelembapan + Suhu + Tekanan_Udara + Penyinaran_Matahari, data = data_train_KacangTanah, ntree = 1000)
...
```{r}
# Membuat model SVR
svr_model_KacangTanah <- svm(Produksi ~ Produktivitas + Luas_Panen + Kecepatan_Angin + Kelembapan + Suhu + Tekanan_Udara + Penyinaran_Matahari, data = data_train_KacangTanah, kernel = "radial", cost = 1)
...
```{r}
# Membuat model RF
rf_model_UbiJalar <- randomForest(Produksi ~ Produktivitas + Luas_Panen + Kecepatan_Angin + Kelembapan + Suhu + Tekanan_Udara + Penyinaran_Matahari, data = data_train_UbiJalar, ntree = 1000)
rf_model_UbiJalar
```
...
```{r}
# Membuat model SVR
svr_model_UbiJalar <- svm(Produksi ~ Produktivitas + Luas_Panen + Kecepatan_Angin + Kelembapan + Suhu + Tekanan_Udara + Penyinaran_Matahari, data = data_train_UbiJalar, kernel = "radial", cost = 1)
svr_model_UbiJalar
```
...
```{r}
# Membuat model RF
rf_model_UbiKayu <- randomForest(Produksi ~ Produktivitas + Luas_Panen + Kecepatan_Angin + Kelembapan + Suhu + Tekanan_Udara + Penyinaran_Matahari, data = data_train_UbiKayu, ntree = 1000)
rf_model_UbiKayu
```
...
```{r}
# Membuat model SVR
svr_model_UbiKayu <- svm(Produksi ~ Produktivitas + Luas_Panen + Kecepatan_Angin + Kelembapan + Suhu + Tekanan_Udara + Penyinaran_Matahari, data = data_train_UbiKayu, kernel = "radial", cost = 1)
svr_model_UbiKayu
```
...
```{r}
# Membuat model RF
rf_model_Jagung <- randomForest(Produksi ~ Produktivitas + Luas_Panen + Kecepatan_Angin + Kelembapan + Suhu + Tekanan_Udara + Penyinaran_Matahari, data = data_train_Jagung, ntree = 1000)
rf_model_Jagung
```
...
```{r}
# Membuat model SVR
svr_model_Jagung <- svm(Produksi ~ Produktivitas + Luas_Panen + Kecepatan_Angin + Kelembapan + Suhu + Tekanan_Udara + Penyinaran_Matahari, data = data_train_Jagung, kernel = "radial", cost = 1)
svr_model_Jagung
```
