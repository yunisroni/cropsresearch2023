...
```{r}
# Hitung total produksi semua tanaman pangan per setiap provinsi
...
### Tren Produksi Tanaman Pangan per Provinsi
...
plot_palawija2 <- ggplot(totproduksi_provinsi, aes(x = Provinsi, y = total_produksi, fill = Provinsi)) +
  ...
  labs(title = "Perbandingan Produksi Palawija antara Provinsi di Indonesia", x = "Provinsi", y = "Total Produksi (Ton)") +
  scale_y_continuous(labels = scales::comma) +
  theme_minimal() +
...
```
Perbandingan produksi palawija dalam kurun waktu 1992 - 2020 adalah dari jawa timur yang terbanyak dengan Jumlah Produksi 260033079.0 Ton
...
## a. GARCH terhadap produksi jagung Indonesia
