...
# Boxplot untuk perbandingan rentang nilai 'suhu'
boxplot(data_iklim_sumatera$Suhu, main = "Boxplot Suhu", ylab = "Nilai Suhu", xlab = "Suhu", names = c("Suhu"))
```

```{r}
boxplot(data_iklim_sumatera$Curah_hujan, main = "Boxplot Curah hujan", ylab = "Nilai", xlab = "Curah hujan", names = c("Curah hujan"))
```


```{r}
# Boxplot untuk perbandingan rentang nilai 'Kelembapan' dan 'curah_hujan
# Boxplot untuk perbandingan rentang nilai 'Kelembapan'
boxplot(data_iklim_sumatera$Kelembapan, main = "Boxplot Kelembapan", ylab = "Nilai Kelembapan", xlab = "Kelembapan", names = c("Kelembapan"))
```

```{r}
# Boxplot untuk perbandingan rentang nilai 'Penyinaran Matahari' dan 'curah_hujan
# Boxplot untuk perbandingan rentang nilai 'Penyinaran Matahari'
boxplot(data_iklim_sumatera$Penyinaran_Matahari, main = "Boxplot Penyinaran Matahari", ylab = "Nilai Penyinaran Matahari", xlab = "Penyinaran Matahari", names = c("Penyinaran Matahari"))
```

```{r}
# Boxplot untuk perbandingan rentang nilai 'Kecepatan Angin' dan 'curah_hujan
# Boxplot untuk perbandingan rentang nilai 'Kecepatan Angin'
boxplot(data_iklim_sumatera$Kecepatan_Angin, main = "Boxplot Kecepatan Angin", ylab = "Nilai Kecepatan Angin", xlab = "Kecepatan Angin", names = c("Kecepatan Angin"))
```
...
mape_ps_padi_VAR <- mape(test_ps_padi_var$Produksi, predict_ps_padi_var)* 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_padi_VAR <- mape(test_pt_padi_var$Produktivitas, predict_pt_padi_var) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_ps_jagung_VAR <- mape(test_ps_jagung_var$Produksi, predict_ps_jagung_var)* 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_jagung_VAR <- mape(test_pt_jagung_var$Produktivitas, predict_pt_jagung_var) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_ps_ubijalar_VAR <- mape(test_ps_ubijalar_var$Produksi, predict_ps_ubijalar_var) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_ubijalar_VAR <- mape(test_pt_ubijalar_var$Produktivitas, predict_pt_ubijalar_var)* 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_ps_ubikayu_VAR <- mape(test_ps_ubikayu_var$Produksi, predict_ps_ubikayu_var) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_ubikayu_VAR <- mape(test_pt_ubikayu_var$Produktivitas, predict_pt_ubikayu_var) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_ps_kedelai_VAR <- mape(test_ps_kedelai_var$Produksi, predict_ps_kedelai_var) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_kedelai_VAR <- mape(test_pt_kedelai_var$Produktivitas, predict_pt_kedelai_var) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_ps_kcgHijau_VAR <- mape_safe(test_ps_kcgHijau_var$Produksi, predict_ps_kcgHijau_var) * 100
...
```
MAE Produksi kacang hijau VAR:  710.615429058764 
MSE Produksi kacang hijau VAR:  836106.640078754 
RMSE Produksi kacang hijau VAR:  914.388670139101 
MAPE Produksi kacang hijau VAR:  12142.2334413924 %
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_kcgHijau_VAR <- mape_safe(test_pt_kcgHijau_var$Produktivitas, predict_pt_kcgHijau_var) * 100
...
```
MAE:  1.26677114552346 
MSE:  8.10820365425123 
RMSE:  2.84749076455943 
MAPE:  509.411998731743 %
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_ps_kcgTanah_VAR <- mape_safe(test_ps_kcgTanah_var$Produksi, predict_ps_kcgtanah_var)* 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_kcgTanah_VAR <- mape_safe(test_pt_kcgTanah_var$Produktivitas, predict_pt_kcgtanah_var) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_ps_padi_glm <- mape(test_ps_padi_glm$Produksi, predict_ps_padi_glm) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_padi_glm  <- mape(test_pt_padi_glm$Produktivitas, predict_pt_padi_glm) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_ps_jagung_glm  <- mape(test_ps_jagung_glm$Produksi, predict_ps_jagung_glm) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_jagung_glm <- mape(test_pt_jagung_glm$Produktivitas, predict_pt_jagung_glm) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_ps_ubijalar_glm <- mape(test_ps_ubijalar_glm$Produksi, predict_ps_ubijalar_glm) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_ubijalar_glm <- mape(test_pt_ubijalar_glm$Produktivitas, predict_pt_ubijalar_glm) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_ps_ubikayu_glm <- mape(test_ps_ubikayu_glm$Produksi, predict_ps_ubikayu_glm) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_ubikayu_glm <- mape(test_pt_ubikayu_glm$Produktivitas, predict_pt_ubikayu_glm)* 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_ps_kedelai_glm <- mape(test_ps_Kedelai_glm$Produksi, predict_ps_Kedelai_glm) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_kedelai_glm <- mape(test_pt_Kedelai_glm$Produktivitas, predict_pt_Kedelai_glm) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_ps_kcgHijau_glm <- mape_safe(test_ps_kcgHijau_glm$Produksi, predict_ps_kcgHijau_glm) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_kcgHijau_glm <- mape_safe(test_pt_kcgHijau_glm$Produktivitas, predict_pt_kcgHijau_glm)* 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_ps_kcgTanah_glm <- mape(test_ps_kcgtanah_glm$Produksi, predict_ps_kcgtanah_glm) * 100
...
# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_kcgtanah_glm <- mape(test_pt_kcgtanah_glm$Produktivitas, predict_pt_kcgtanah_glm) * 100
...
evaluasi <- data.frame(
  ...
  MAPE_VAR = c(4544.1450, 20755.4933, 548.5922, 3550.0147, 114054.7829, 12142.2334, 86358.7793),
  MAPE_GLM = c(16073.4035, 10681.1311, 180.1089, 2851.0007, 77187.2941, 117122.9906, 293.2129)
)
```
...
evaluasi_produktivitas <- data.frame(
  ...
  MAPE_VAR = c(16.87786,35.06395, 35.48572, 31.29015, 16.20053, 509.41200, 884.39225),
  MAPE_GLM = c(10.75922, 18.14903, 23.76202, 22.78829, 9.05099, 955.18736, 8.83603)
)
```
