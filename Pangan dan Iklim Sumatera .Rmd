...
plot_sumatera1 <- ggplot(Iklim_clean, aes(x = Tahun, y = total_produksi, color = Provinsi)) +
  geom_line() +
  geom_point() +
...
plot_sumatera2 <- ggplot(Iklim_clean, aes(x = Provinsi, y = total_produksi, fill = Provinsi)) +
  geom_bar(stat = "identity") +
  labs(title = "Perbandingan Produksi Tanaman pangan antar Provinsi di Sumatera", x = "Provinsi", y = "Total Produksi (Ton)") +
  scale_y_continuous(labels = scales::comma) +
  theme_minimal() +
  theme(legend.position = "none")  # hilangkan legend

# Rotasi sumbu x agar mudah dibaca
plot_sumatera2 + theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
Produksi tanaman pangan terbanyak di pulau sumatera dalam kurun waktu 2006 - 2015 adalah dari provinsi dengan Jumlah Produksi .... Ton
