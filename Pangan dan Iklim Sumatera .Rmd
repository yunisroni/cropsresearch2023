...
```{r}
# Hitung MAE (Mean Absolute Error)
mae_value_VAR <- mae(test_ps_ubikayu_var$Produksi, predict_ps_ubikayu_var)

# Hitung MSE (Mean Squared Error)
mse_value_VAR <- mse(test_ps_ubikayu_var$Produksi, predict_ps_ubikayu_var)

# Hitung RMSE (Root Mean Square Error)
rmse_value_VAR <- rmse(test_ps_ubikayu_var$Produksi, predict_ps_ubikayu_var)

# Hitung MAPE (Mean Absolute Percent Error)
mape_value_VAR <- mape(test_ps_ubikayu_var$Produksi, predict_ps_ubikayu_var)
...
ggplot(data = result_pt_kedelai_VAR, aes(x = Produktivitas_actual5, y = Produktivitas_pred5)) +
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(x = "Actual Produktivitas", y = "Predicted Produktivitas") +
  ggtitle("Perbandingan Produktivitas kacang kedelai Aktual dengan Prediksi Model VAR") +
  theme_minimal()
```
...
# Tampilkan hasil evaluasi
cat(paste("MAE: ", mae_pt_kedelai_VAR, "\n"))
cat(paste("MSE: ", mse_pt_kedelai_VAR, "\n"))
cat(paste("RMSE: ", rmse_pt_kedelai_VAR, "\n"))
cat(paste("MAPE: ", mape_pt_kedelai_VAR, "%\n"))
...
ggplot(data = result_ps_kcgHijau_VAR, aes(x = Produksi_actual6, y = Produksi_pred6)) +
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(x = "Actual Produksi", y = "Predicted Produksi") +
  ggtitle("Perbandingan Produksi kacang Hijau Aktual dengan Prediksi Model VAR") +
  theme_minimal()
```
...
ggplot(data = result_pt_kcgHijau_VAR, aes(x = Produktivitas_actual6, y = Produktivitas_pred6)) +
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(x = "Actual Produktivitas", y = "Predicted Produktivitas") +
  ggtitle("Perbandingan Produktivitas kacang Hijau Aktual dengan Prediksi Model VAR") +
  theme_minimal()
```
...
ggplot(data = result_ps_kcgtanah_VAR, aes(x = Produksi_actual7, y = Produksi_pred7)) +
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(x = "Actual Produksi", y = "Predicted Produksi") +
  ggtitle("Perbandingan Produksi kacang tanah Aktual dengan Prediksi Model VAR") +
  theme_minimal()
```
...
ggplot(data = result_pt_kcgtanah_VAR, aes(x = Produktivitas_actual7, y = Produktivitas_pred7)) +
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(x = "Actual Produktivitas", y = "Predicted Produktivitas") +
  ggtitle("Perbandingan Produktivitas kacang tanah Aktual dengan Prediksi Model VAR") +
  theme_minimal()
```
...
```{r}
# Hitung MAE (Mean Absolute Error)
mae_value_VAR <- mae(test_pt_kcgTanah_var$Produktivitas, predict_pt_kcgtanah_var)

# Hitung MSE (Mean Squared Error)
mse_value_VAR <- mse(test_pt_kcgTanah_var$Produktivitas, predict_pt_kcgtanah_var)

# Hitung RMSE (Root Mean Square Error)
rmse_value_VAR <- rmse(test_pt_kcgTanah_var$Produktivitas, predict_pt_kcgtanah_var)

# Hitung MAPE (Mean Absolute Percent Error)
mape_value_VAR <- mape_safe(test_pt_kcgTanah_var$Produktivitas, predict_pt_kcgtanah_var)
...
*hasil*
Berdasarkan hasil di atas, variabel iklim yang menunjukkan dampak signifikan terhadap produktivitas padi adalah curah hujan dan kecepatan angin karena nilai p untuk variabel *Curah_hujan* dengan nilai p  0.02174 (*).
*Kecepatan_Angin* dengan nilai p sekitar 0.00095 (***).
...
ggplot(data = result_pt_ubijalar_glm, aes(x = Produktivitas_3, y = Predictions_6)) +
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(x = "Actual Produktivitas", y = "Predicted Produktivitas") +
  ggtitle("Perbandingan Produktivitas Ubi jalar Aktual dengan Prediksi Model GLM") +
  theme_minimal()
```
...
```
*hasil* 
Berdasarkan hasil di atas, variabel iklim yang menunjukkan dampak signifikan terhadap produksi ubi kayu adalah variabel penyinaran matahari dan kecepatan angin  karena nilai p-value untuk variabel *Penyinaran_Matahari* dengan nilai p value 0.00805 (** ) *Kecepatan_Angin* dengan nilai p sekitar 0.00959 (** ) yg lebih kecil dari 0,05
...
ggplot(data = result_ps_ubikayu_glm, aes(x = Produksi_4, y = Predictions_7)) +
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(x = "Actual Produksi", y = "Predicted Produksi") +
  ggtitle("Perbandingan Produksi Ubi Kayu Aktual dengan Prediksi Model GLM") +
  theme_minimal()
```
...
ggplot(data = result_pt_ubikayu_glm, aes(x = Produktivitas_4, y = Predictions_8)) +
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(x = "Actual Produktivitas", y = "Predicted Produktivitas") +
  ggtitle("Perbandingan Produktivitas Ubi Kayu Aktual dengan Prediksi Model GLM") +
  theme_minimal()
```
...
ggplot(data = result_ps_Kedelai_glm, aes(x = Produksi_5, y = Predictions_9)) +
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(x = "Actual Produksi", y = "Predicted Produksi") +
  ggtitle("Perbandingan Produksi Kacang Kedelai Aktual dengan Prediksi Model GLM") +
  theme_minimal()
```
...
ggplot(data = result_pt_Kedelai_glm, aes(x = Produktivitas_5, y = Predictions_10)) +
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(x = "Actual Produktivitas", y = "Predicted Produktivitas") +
  ggtitle("Perbandingan Produktivitas Kacang Kedelai Aktual dengan Prediksi Model GLM ") +
  theme_minimal()
```
...
# Tampilkan hasil evaluasi
cat(paste("MAE: ", mae_pt_kedelai_glm, "\n"))
cat(paste("MSE: ", mse_pt_kedelai_glm, "\n"))
cat(paste("RMSE: ", rmse_pt_kedelai_glm, "\n"))
cat(paste("MAPE: ", mape_pt_kedelai_glm, "%\n"))
```
...
ggplot(data = result_ps_kcgHijau_glm, aes(x = Produksi_6, y = Predictions_11)) +
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(x = "Actual Produksi", y = "Predicted Produksi") +
  ggtitle("Perbandingan Produksi Kacang Hijau Aktual dengan Prediksi Model GLM") +
  theme_minimal()
```
...
ggplot(data = result_pt_kcgHijau_glm, aes(x = Produktivitas_6, y = Predictions_12)) +
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(x = "Actual Produktivitas", y = "Predicted Produktivitas") +
  ggtitle("Perbandingan Produktivitas Kacang Hijau Aktual dengan Prediksi Model GLM") +
  theme_minimal()
```
...
```
*hasil* 
Berdasarkan hasil di atas, variabel iklim yang menunjukkan dampak signifikan terhadap produktsi kacang tanah adalah variabel  curah hujan dan kecepatn angin  karena nilai p-value *curah hujan* dengan nilai p sekitar  0.04395  (* ) dan *kecepatn agin*  dengan bilai p value  0.00033 (***) yg lebih kecil dari 0,05
...
ggplot(data = result_ps_kcgtanah_glm, aes(x = Produksi_7, y = Predictions_13)) +
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(x = "Actual Produksi", y = "Predicted Produksi") +
  ggtitle("Perbandingan Produksi Kacang Tanah Aktual dengan Prediksi Model GLM") +
  theme_minimal()
```
...
```{r}
# Hitung MAE (Mean Absolute Error)
mae_pt_kcgTanah_glm <- mae(test_ps_kcgtanah_glm$Produksi, predict_ps_kcgtanah_glm)

# Hitung MSE (Mean Squared Error)
mse_pt_kcgTanah_glm <- mse(test_ps_kcgtanah_glm$Produksi, predict_ps_kcgtanah_glm)

# Hitung RMSE (Root Mean Square Error)
rmse_pt_kcgTanah_glm <- rmse(test_ps_kcgtanah_glm$Produksi, predict_ps_kcgtanah_glm)

# Hitung MAPE (Mean Absolute Percent Error)
mape_pt_kcgTanah_glm <- mape(test_ps_kcgtanah_glm$Produksi, predict_ps_kcgtanah_glm)
...
```
*hasil* 
Berdasarkan hasil di atas, variabel iklim yang menunjukkan dampak signifikan terhadap produktivitas kacang tanah adalah variabel  kecepatn angin  karena nilai p-value *kecepatn agin*  dengan nilai p value  0.00262 (**) yg lebih kecil dari 0,05
...
ggplot(data = result_pt_kcgtanah_glm, aes(x = Produktivitas_7, y = Predictions_14)) +
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(x = "Actual Produktivitas", y = "Predicted Produktivitas") +
  ggtitle("Perbandingan Produktivitas Kacang Tanah Aktual dengan Prediksi Model GLM") +
  theme_minimal()
```
