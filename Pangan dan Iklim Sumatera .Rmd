...
```{r}
# Melihat statistik deskriptif dari variabel produksi pada data uji
summary(test_ps_padi_var$Produksi)

```
output:
  Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
     959   460980  1888501  2341581  3553295 18511853 
     
```{r}
summary(test_ps_padi_glm$Produksi)
```
outptu:
 Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
    430  493203 1961287 1810102 3192197 4044829 


```{r}
# Menghitung statistik dasar
mean_produksi_var <- mean(test_ps_padi_var$Produksi)
sd_produksi_var <- sd(test_ps_padi_var$Produksi)
min_produksi_var <- min(test_ps_padi_var$Produksi)
max_produksi_var <- max(test_ps_padi_var$Produksi)

mean_produksi_glm <- mean(test_ps_padi_glm$Produksi)
sd_produksi_glm <- sd(test_ps_padi_glm$Produksi)
min_produksi_glm <- min(test_ps_padi_glm$Produksi)
max_produksi_glm <- max(test_ps_padi_glm$Produksi)

# Menampilkan statistik dasar
cat("Statistik Produksi Padi (VAR):\n")
cat("Mean: ", mean_produksi_var, "\n")
cat("Standard Deviation: ", sd_produksi_var, "\n")
cat("Minimum: ", min_produksi_var, "\n")
cat("Maximum: ", max_produksi_var, "\n")

cat("\nStatistik Produksi Padi (GLM):\n")
cat("Mean: ", mean_produksi_glm, "\n")
cat("Standard Deviation: ", sd_produksi_glm, "\n")
cat("Minimum: ", min_produksi_glm, "\n")
cat("Maximum: ", max_produksi_glm, "\n")
