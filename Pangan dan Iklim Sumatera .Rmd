...
cat(paste("MAE: ", mae_ps_padi_VAR, "\n"))
cat(paste("MSE: ", mse_ps_padi_VAR, "\n"))
cat(paste("RMSE: ", rmse_ps_padi_VAR, "\n"))
cat(paste("MAPE: ", mape_ps_padi_VAR, "%\n"))
...
```{r}
# Melakukan uji Granger Causality 
granger_padi_sumatera9 <- causality(var_model_Padi_sumatera2, cause = "Kecepatan_Angin")
...
# Tampilkan hasil evaluasi
cat(paste("MAE: ", mae_ps_jagung_VAR, "\n"))
cat(paste("MSE: ", mse_ps_jagung_VAR, "\n"))
cat(paste("RMSE: ", rmse_ps_jagung_VAR, "\n"))
cat(paste("MAPE: ", mape_ps_jagung_VAR, "%\n"))
...
# Tampilkan hasil evaluasi
cat(paste("MAE: ", mae_ps_ubijalar_VAR, "\n"))
cat(paste("MSE: ", mse_ps_ubijalar_VAR, "\n"))
cat(paste("RMSE: ", rmse_ps_ubijalar_VAR, "\n"))
cat(paste("MAPE: ", mape_ps_ubijalar_VAR, "%\n"))
...
# Tampilkan hasil evaluasi
cat(paste("MAE: ", mae_ps_kcgHijau_VAR, "\n"))
cat(paste("MSE: ", mse_ps_kcgHijau_VAR, "\n"))
cat(paste("RMSE: ", rmse_ps_kcgHijau_VAR, "\n"))
cat(paste("MAPE: ", mape_ps_kcgHijau_VAR, "%\n"))
...
```{r}
### Produksi padi
evaluasi_model_ps_padi <- data.frame(
  No = c(1:2),
  Model = c("Model VAR", "Model GLM"),
  MSE = c(mae_ps_padi_VAR, mae_ps_padi_glm),
  RSME = c(mse_ps_padi_VAR, mse_ps_padi_glm),
  MAE = c(rmse_ps_padi_VAR, rmse_ps_padi_glm),
  MAPE = c(mape_ps_padi_VAR, mape_ps_padi_glm),
  stringsAsFactors = FALSE
  
)
evaluasi_model_ps_padi
```


```{r}
### Produktivitas padi
evaluasi_model_pt_padi <- data.frame(
  No = c(1:2),
  Model = c("Model VAR", "Model GLM"),
  MSE = c(mae_pt_padi_VAR, mae_pt_padi_glm),
  RSME = c(mse_pt_padi_VAR, mse_pt_padi_glm),
  MAE = c(rmse_pt_padi_VAR, rmse_pt_padi_glm),
  MAPE = c(mape_pt_padi_VAR, mape_pt_padi_glm),
  stringsAsFactors = FALSE
  
)
evaluasi_model_pt_padi
```


```{r}
### Produksi jagung
evaluasi_model_ps_jagung <- data.frame(
  No = c(1:2),
  Model = c("Model VAR", "Model GLM"),
  MSE = c(mae_ps_jagung_VAR, mae_ps_jagung_glm),
  RSME = c(mse_ps_jagung_VAR, mse_ps_jagung_glm),
  MAE = c(rmse_ps_jagung_VAR, rmse_ps_jagung_glm),
  MAPE = c(mape_ps_jagung_VAR, mape_ps_jagung_glm),
  stringsAsFactors = FALSE
  
)
evaluasi_model_ps_jagung
```


```{r}
### Produktivitas jagung
evaluasi_model_pt_jagung <- data.frame(
  No = c(1:2),
  Model = c("Model VAR", "Model GLM"),
  MSE = c(mae_pt_jagung_VAR, mae_pt_jagung_glm),
  RSME = c(mse_pt_jagung_VAR, mse_pt_jagung_glm),
  MAE = c(rmse_pt_jagung_VAR, rmse_pt_jagung_glm),
  MAPE = c(mape_pt_jagung_VAR, mape_pt_jagung_glm),
  stringsAsFactors = FALSE
  
)
evaluasi_model_pt_jagung
```


```{r}
### Produksi ubijalar
evaluasi_model_ps_ubijalar <- data.frame(
  No = c(1:2),
  Model = c("Model VAR", "Model GLM"),
  MSE = c(mae_ps_ubijalar_VAR, mae_ps_ubijalar_glm),
  RSME = c(mse_ps_ubijalar_VAR, mse_ps_ubijalar_glm),
  MAE = c(rmse_ps_ubijalar_VAR, rmse_ps_ubijalar_glm),
  MAPE = c(mape_ps_ubijalar_VAR, mape_ps_ubijalar_glm),
  stringsAsFactors = FALSE
  
)
evaluasi_model_ps_ubijalar
```


```{r}
### Produktivitas ubijalar
evaluasi_model_pt_ubijalar <- data.frame(
  No = c(1:2),
  Model = c("Model VAR", "Model GLM"),
  MSE = c(mae_pt_ubijalar_VAR, mae_pt_ubijalar_glm),
  RSME = c(mse_pt_ubijalar_VAR, mse_pt_ubijalar_glm),
  MAE = c(rmse_pt_ubijalar_VAR, rmse_pt_ubijalar_glm),
  MAPE = c(mape_pt_ubijalar_VAR, mape_pt_ubijalar_glm),
  stringsAsFactors = FALSE
  
)
evaluasi_model_pt_ubijalar
```

```{r}
### Produksi ubikayu
evaluasi_model_ps_ubikayu <- data.frame(
  No = c(1:2),
  Model = c("Model VAR", "Model GLM"),
  MSE = c(mae_ps_ubikayu_VAR, mae_ps_ubikayu_glm),
  RSME = c(mse_ps_ubikayu_VAR, mse_ps_ubikayu_glm),
  MAE = c(rmse_ps_ubikayu_VAR, rmse_ps_ubikayu_glm),
  MAPE = c(mape_ps_ubikayu_VAR, mape_ps_ubikayu_glm),
  stringsAsFactors = FALSE
  
)
evaluasi_model_ps_ubikayu
```


```{r}
### Produktivitas ubikayu
evaluasi_model_pt_ubikayu <- data.frame(
  No = c(1:2),
  Model = c("Model VAR", "Model GLM"),
  MSE = c(mae_pt_ubikayu_VAR, mae_pt_ubikayu_glm),
  RSME = c(mse_pt_ubikayu_VAR, mse_pt_ubikayu_glm),
  MAE = c(rmse_pt_ubikayu_VAR, rmse_pt_ubikayu_glm),
  MAPE = c(mape_pt_ubikayu_VAR, mape_pt_ubikayu_glm),
  stringsAsFactors = FALSE
  
)
evaluasi_model_pt_ubikayu
```

```{r}
### Produksi kedelai
evaluasi_model_ps_kedelai <- data.frame(
  No = c(1:2),
  Model = c("Model VAR", "Model GLM"),
  MSE = c(mae_ps_kedelai_VAR, mae_ps_kedelai_glm),
  RSME = c(mse_ps_kedelai_VAR, mse_ps_kedelai_glm),
  MAE = c(rmse_ps_kedelai_VAR, rmse_ps_kedelai_glm),
  MAPE = c(mape_ps_kedelai_VAR, mape_ps_kedelai_glm),
  stringsAsFactors = FALSE
  
)
evaluasi_model_ps_kedelai
```


```{r}
### Produktivitas kedelai
evaluasi_model_pt_kedelai <- data.frame(
  No = c(1:2),
  Model = c("Model VAR", "Model GLM"),
  MSE = c(mae_pt_kedelai_VAR, mae_pt_kedelai_glm),
  RSME = c(mse_pt_kedelai_VAR, mse_pt_kedelai_glm),
  MAE = c(rmse_pt_kedelai_VAR, rmse_pt_kedelai_glm),
  MAPE = c(mape_pt_kedelai_VAR, mape_pt_kedelai_glm),
  stringsAsFactors = FALSE
  
)
evaluasi_model_pt_kedelai
```

```{r}
### Produksi kacang Hijau
evaluasi_model_ps_kcgHijau <- data.frame(
  No = c(1:2),
  Model = c("Model VAR", "Model GLM"),
  MSE = c(mae_ps_kcgHijau_VAR, mae_ps_kcgHijau_glm),
  RSME = c(mse_ps_kcgHijau_VAR, mse_ps_kcgHijau_glm),
  MAE = c(rmse_ps_kcgHijau_VAR, rmse_ps_kcgHijau_glm),
  MAPE = c(mape_ps_kcgHijau_VAR, mape_ps_kcgHijau_glm),
  stringsAsFactors = FALSE
  
)
evaluasi_model_ps_kcgHijau
```


```{r}
### Produktivitas Kacang Hijau
evaluasi_model_pt_kcgHijau <- data.frame(
  No = c(1:2),
  Model = c("Model VAR", "Model GLM"),
  MSE = c(mae_pt_kcgHijau_VAR, mae_pt_kcgHijau_glm),
  RSME = c(mse_pt_kcgHijau_VAR, mse_pt_kcgHijau_glm),
  MAE = c(rmse_pt_kcgHijau_VAR, rmse_pt_kcgHijau_glm),
  MAPE = c(mape_pt_kcgHijau_VAR, mape_pt_kcgHijau_glm),
  stringsAsFactors = FALSE
  
)
evaluasi_model_pt_kcgHijau
```

```{r}
### Produksi kacang Tanah
evaluasi_model_ps_kcgTanah <- data.frame(
  No = c(1:2),
  Model = c("Model VAR", "Model GLM"),
  MSE = c(mae_ps_kcgTanah_VAR, mae_ps_kcgTanah_glm),
  RSME = c(mse_ps_kcgTanah_VAR, mse_ps_kcgTanah_glm),
  MAE = c(rmse_ps_kcgTanah_VAR, rmse_ps_kcgTanah_glm),
  MAPE = c(mape_ps_kcgTanah_VAR, mape_ps_kcgTanah_glm),
  stringsAsFactors = FALSE
  
)
evaluasi_model_ps_kcgTanah
```


```{r}
### Produktivitas Kacang Tanah
evaluasi_model_pt_kcgTanah <- data.frame(
  No = c(1:2),
  Model = c("Model VAR", "Model GLM"),
  MSE = c(mae_pt_kcgTanah_VAR, mae_pt_kcgtanah_glm),
  RSME = c(mse_pt_kcgTanah_VAR, mse_pt_kcgtanah_glm),
  MAE = c(rmse_pt_kcgTanah_VAR, rmse_pt_kcgtanah_glm),
  MAPE = c(mape_pt_kcgTanah_VAR, mape_pt_kcgtanah_glm),
  stringsAsFactors = FALSE
  
)
evaluasi_model_pt_kcgTanah
```
...
evaluasi_model_komoditas <- data.frame(
  ...
  MSE_VAR = c(mae_ps_padi_VAR, mae_ps_jagung_VAR, mae_ps_ubijalar_VAR, mae_ps_ubikayu_VAR, mae_ps_kedelai_VAR, mae_ps_kcgHijau_VAR, mae_ps_kcgTanah_VAR),
  MSE_GLM = c(mae_ps_padi_glm, mae_ps_jagung_glm, mae_ps_ubijalar_glm, mae_ps_ubikayu_glm, mae_ps_kedelai_glm, mae_ps_kcgHijau_glm, mae_ps_kcgTanah_glm),
  RMSE_VAR = c(mse_ps_padi_VAR, mse_ps_jagung_VAR, mse_ps_ubijalar_VAR, mse_ps_ubikayu_VAR, mse_ps_kedelai_VAR, mse_ps_kcgHijau_VAR, mse_ps_kcgTanah_VAR),
  RMSE_GLM = c(mse_ps_padi_glm, mse_ps_jagung_glm, mse_ps_ubijalar_glm, mse_ps_ubikayu_glm, mse_ps_kedelai_glm, mse_ps_kcgHijau_glm, mse_ps_kcgTanah_glm),
  MAE_VAR = c(rmse_ps_padi_VAR, rmse_ps_jagung_VAR, rmse_ps_ubijalar_VAR, rmse_ps_ubikayu_VAR, rmse_ps_kedelai_VAR, rmse_ps_kcgHijau_VAR, rmse_ps_kcgTanah_VAR),
  MAE_GLM = c(rmse_ps_padi_glm, rmse_ps_jagung_glm, rmse_ps_ubijalar_glm, rmse_ps_ubikayu_glm, rmse_ps_kedelai_glm, rmse_ps_kcgHijau_glm, rmse_ps_kcgTanah_glm),
...
evaluasi_model_produktivitas <- data.frame(
  ...
  MSE_VAR = c(mae_pt_padi_VAR, mae_pt_jagung_VAR, mae_pt_ubijalar_VAR, mae_pt_ubikayu_VAR, mae_pt_kedelai_VAR, mae_pt_kcgHijau_VAR, mae_pt_kcgTanah_VAR),
  MSE_GLM = c(mae_pt_padi_glm, mae_pt_jagung_glm, mae_pt_ubijalar_glm, mae_pt_ubikayu_glm, mae_pt_kedelai_glm, mae_pt_kcgHijau_glm, mae_pt_kcgtanah_glm),
  RMSE_VAR = c(mse_pt_padi_VAR, mse_pt_jagung_VAR, mse_pt_ubijalar_VAR, mse_pt_ubikayu_VAR, mse_pt_kedelai_VAR, mse_pt_kcgHijau_VAR, mse_pt_kcgTanah_VAR),
  RMSE_GLM = c(mse_pt_padi_glm, mse_pt_jagung_glm, mse_pt_ubijalar_glm, mse_pt_ubikayu_glm, mse_pt_kedelai_glm, mse_pt_kcgHijau_glm, mse_pt_kcgtanah_glm),
  MAE_VAR = c(rmse_pt_padi_VAR, rmse_pt_jagung_VAR, rmse_pt_ubijalar_VAR, rmse_pt_ubikayu_VAR, rmse_pt_kedelai_VAR, rmse_pt_kcgHijau_VAR, rmse_pt_kcgTanah_VAR),
  MAE_GLM = c(rmse_pt_padi_glm, rmse_pt_jagung_glm, rmse_pt_ubijalar_glm, rmse_pt_ubikayu_glm, rmse_pt_kedelai_glm, rmse_pt_kcgHijau_glm, rmse_pt_kcgtanah_glm),
