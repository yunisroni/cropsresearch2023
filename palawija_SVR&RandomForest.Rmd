...
##### - Kacang Hijau
```{r}
# Membuat grid untuk mtry
mtryGrid <- expand.grid(mtry = c(1,2))  # Ganti dengan nilai mtry yang ingin diuji
...
```{r}
gs_ubikayu_rf_model <- randomForest(Produksi ~ Produktivitas + Luas_Panen, data = dataubikayu_train, ntree = 1000,mtry=1 )
gs_ubikayu_rf_model
```
...
# Tentukan grid dari hiperparameter yang ingin dioptimalkan
grid <- expand.grid(mtry = seq(1, 2, by = 1))

# Membuat kontrol untuk validasi silang
control <- trainControl(method = "cv", number = 5)

# Melakukan train dengan fungsi train
set.seed(123)
jagung_rf_model <- train(
  Produksi ~ Produktivitas + Luas_Panen,
  data = datajagung_train,
  method = "rf",
  trControl = control,
...
# Melihat hasil optimalisasi
print(jagung_rf_model)
