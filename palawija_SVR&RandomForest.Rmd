...
```{r}
gs_ubijalar_rf_model <- randomForest(Produksi ~ Produktivitas + Luas_Panen, data = dataubijalar_train, ntree = 1000,mtry=1)
...
```{r}
# Melakukan Prediksi terhadap Data Pengujian
rs_ubijalar_rf_model <- randomForest(Produksi ~ Produktivitas + Luas_Panen, data = dataubijalar_train, ntree = 1000,mtry=1 )
...
#####- Ubi Kayu
```{r}
rs_ubikayu_rf <- train(Produksi ~ Produktivitas + Luas_Panen, data=dataubikayu_train, method="rf", tuneLength=5, trControl=controlRS)

print(rs_ubikayu_rf)
```
The final value used for the model was mtry = 1.
```{r}
rs_ubikayu_rf_model <- randomForest(Produksi ~ Produktivitas + Luas_Panen, data = dataubikayu_train, ntree = 1000,mtry=1 )
rs_ubikayu_rf_model
```
```{r}
# Melakukan Prediksi terhadap Data Pengujian
...
```
The final values used for the model were sigma = 0.303019 and C = 10.91573.
...
```{r}
# Visualisasi hasil prediksi
rs_result_datajagung_svr_radial <- data.frame(Produksi = datajagung_test$Produksi, Predictions = rs_predictions_svr_jagung_radial)

ggplot(data = rs_result_datajagung_svr_radial, aes(x = Produksi, y = Predictions)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "red", linetype = "dashed") +
  labs(x = "Produksi Aktual (Ton)", y = "Prediksi Produksi (Ton)") +
  scale_x_continuous(labels = scales::comma) +
...
```{r}
# Visualisasi hasil prediksi
rs_result_datakacanghijau_svr_radial <- data.frame(Produksi = datakacanghijau_test$Produksi, Predictions = rs_predictions_svr_kacanghijau_radial)

ggplot(data = rs_result_datakacanghijau_svr_radial, aes(x = Produksi, y = Predictions)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "red", linetype = "dashed") +
  labs(x = "Produksi Aktual (Ton)", y = "Prediksi Produksi (Ton)") +
  scale_x_continuous(labels = scales::comma) +
...
```
The final values used for the model were sigma = 0.1000824 and C = 88.8122.
...
```{r}
# Visualisasi hasil prediksi
rs_result_datakacangkedelai_svr_radial <- data.frame(Produksi = datakacangkedelai_test$Produksi, Predictions = rs_predictions_svr_kacangkedelai_radial)

ggplot(data = rs_result_datakacangkedelai_svr_radial, aes(x = Produksi, y = Predictions)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "red", linetype = "dashed") +
  labs(x = "Produksi Aktual (Ton)", y = "Prediksi Produksi (Ton)") +
  scale_x_continuous(labels = scales::comma) +
...
```
The final values used for the model were sigma = 0.1271073 and C = 34.57035.
...
```{r}
# Visualisasi hasil prediksi
rs_result_datakacangtanah_svr_radial<- data.frame(Produksi = datakacangtanah_test$Produksi, Predictions = rs_predictions_svr_kacangtanah_radial)

ggplot(data = rs_result_datakacangtanah_svr_radial, aes(x = Produksi, y = Predictions)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "red", linetype = "dashed") +
  labs(x = "Produksi Aktual (Ton)", y = "Prediksi Produksi (Ton)") +
  scale_x_continuous(labels = scales::comma) +
...
```
The final values used for the model were sigma = 0.4187884 and C = 1.775559.
...
```{r}
# Visualisasi hasil prediksi
rs_result_dataubijalar_svr_radial <- data.frame(Produksi = dataubijalar_test$Produksi, Predictions = rs_predictions_svr_ubijalar_radial)

ggplot(data = rs_result_dataubijalar_svr_radial, aes(x = Produksi, y = Predictions)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "red", linetype = "dashed") +
  labs(x = "Produksi Aktual (Ton)", y = "Prediksi Produksi (Ton)") +
  scale_x_continuous(labels = scales::comma) +
...
```{r}
# Visualisasi hasil prediksi
rs_result_dataubikayu_radial <- data.frame(Produksi = dataubikayu_test$Produksi, Predictions = rs_predictions_svr_ubikayu_radial)

ggplot(data = rs_result_dataubikayu_radial, aes(x = Produksi, y = Predictions)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "red", linetype = "dashed") +
  labs(x = "Produksi Aktual (Ton)", y = "Prediksi Produksi (Ton)") +
  scale_x_continuous(labels = scales::comma) +
...
The final value used for the model was C = 4.50806.
...
```{r}
# Visualisasi hasil prediksi
rs_result_datajagung_svr_linear <- data.frame(Produksi = datajagung_test$Produksi, Predictions = rs_predictions_svr_jagung_linear)

ggplot(data = rs_result_datajagung_svr_linear, aes(x = Produksi, y = Predictions)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "red", linetype = "dashed") +
  labs(x = "Produksi Aktual (Ton)", y = "Prediksi Produksi (Ton)") +
  scale_x_continuous(labels = scales::comma) +
...
```
The final value used for the model was C = 76.8322
...
```{r}
# Visualisasi hasil prediksi
rs_result_datakacanghijau_svr_linear <- data.frame(Produksi = datakacanghijau_test$Produksi, Predictions = rs_predictions_svr_kacanghijau_linear)

ggplot(data = rs_result_datakacanghijau_svr_linear, aes(x = Produksi, y = Predictions)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "red", linetype = "dashed") +
  labs(x = "Produksi Aktual (Ton)", y = "Prediksi Produksi (Ton)") +
  scale_x_continuous(labels = scales::comma) +
...
```
The final value used for the model was C = 7.018313.
...
```{r}
# Visualisasi hasil prediksi
rs_result_datakacangkedelai_svr_linear <- data.frame(Produksi = datakacangkedelai_test$Produksi, Predictions = rs_predictions_svr_kacangkedelai_linear)

ggplot(data = rs_result_datakacangkedelai_svr_linear, aes(x = Produksi, y = Predictions)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "red", linetype = "dashed") +
  labs(x = "Produksi Aktual (Ton)", y = "Prediksi Produksi (Ton)") +
  scale_x_continuous(labels = scales::comma) +
...
```
The final value used for the model was C = 58.43767.
```{r}
# Membuat model SVR dengan hiperparameter terbaik
...
```{r}
# Visualisasi hasil prediksi
rs_result_datakacangtanah_svr_linear<- data.frame(Produksi = datakacangtanah_test$Produksi, Predictions = rs_predictions_svr_kacangtanah_linear)

ggplot(data = rs_result_datakacangtanah_svr_linear, aes(x = Produksi, y = Predictions)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "red", linetype = "dashed") +
  labs(x = "Produksi Aktual (Ton)", y = "Prediksi Produksi (Ton)") +
  scale_x_continuous(labels = scales::comma) +
...
```
The final value used for the model was C = 62.00529
...
```{r}
# Visualisasi hasil prediksi
rs_result_dataubijalar_svr_linear <- data.frame(Produksi = dataubijalar_test$Produksi, Predictions = rs_predictions_svr_ubijalar_linear)

ggplot(data = rs_result_dataubijalar_svr_linear, aes(x = Produksi, y = Predictions)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "red", linetype = "dashed") +
  labs(x = "Produksi Aktual (Ton)", y = "Prediksi Produksi (Ton)") +
  scale_x_continuous(labels = scales::comma) +
...
```
The final value used for the model was C = 74.44849
...
```{r}
# Visualisasi hasil prediksi
rs_result_dataubikayu_linear <- data.frame(Produksi = dataubikayu_test$Produksi, Predictions = rs_predictions_svr_ubikayu_linear)

ggplot(data = rs_result_dataubikayu_linear, aes(x = Produksi, y = Predictions)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "red", linetype = "dashed") +
  labs(x = "Produksi Aktual (Ton)", y = "Prediksi Produksi (Ton)") +
  scale_x_continuous(labels = scales::comma) +
