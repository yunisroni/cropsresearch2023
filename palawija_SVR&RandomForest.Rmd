...
```
The final values used for the model were sigma = 0.1610078 and C = 24.52022.
```{r}
# Membuat model SVR dengan hiperparameter terbaik
...
```
The final values used for the model were sigma = 0.1159215 and C = 1.35561.
...
```
The final value used for the model was C = 0.6634233.
```{r}
# Membuat model SVR dengan hiperparameter terbaik
...
```
The final value used for the model was C = 29.53511.
...
```
The final value used for the model was C = 79.91891.
...
# Mengatur Optimisasi hyperparameter
## grid search
hyper_grid_poly <- expand.grid( degree = c(2, 3, 4),  # Tambahkan degree
                                scale = c(0.1, 1, 10),
                                C = c(0.1, 1, 10, 100))

## random search
hyper_grid_random_poly <- data.frame(degree = runif(50, 2, 4),
                                     scale = runif(50, 0.1, 10),
                                C = runif(50, 0.1, 100))
...
```
The final values used for the model were degree = 3.001645, scale = 6.155468 and C = 30.84844.
```{r}
# Membuat model SVR dengan hiperparameter terbaik
...
#### b. Random search
```{r}
datakacanghijau_train$Produksi[is.na(datakacanghijau_train$Produksi)] <- mean(datakacanghijau_train$Produksi, na.rm = TRUE)
# Melakukan random search
...
```
The final values used for the model were degree = 3.677383, scale = 7.735814 and C = 10.24228.
...
#6. Intepretasikan dan Membandingkan Model Random Forest dan SVR
