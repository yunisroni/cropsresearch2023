...
# Melakukan grid search dengan menggunakan svmRadial atau svmLinear
gs_jagung_svm <- train(Produksi ~ Produktivitas + Luas_Panen,
                       data = datajagung_train,
                       method = "svmRadial",  # Ganti dengan svmLinear jika menggunakan kernel linear
                       trControl = trainControl(method = "cv", number = 5),
                       tuneGrid = tuneGrid
)
