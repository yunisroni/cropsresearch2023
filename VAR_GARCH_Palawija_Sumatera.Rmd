...
data_aktual_ptj <- Sumatera_ubi_kayu[format(Sumatera_ubi_kayu$Tahun, "%Y") >= "2013", "Produktivitas"]
data_aktual_ptj
```
...
cat("MAPE Produktivitas Ubi kayu:", mape_garch_ptj, "%\n")
cat("RMSE Produktivitas Ubi kayu:", rmse_garch_ptj, "\n")
cat("MAE Produktivitas Ubi kayu:", mae_garch_ptj, "\n")
cat("MSE Produktivitas Ubi kayu:", mse_garch_ptj, "\n")
```
...
result_table <- rbind(
  ...
  data.frame(
    Metric = "MAPE",
    Produktivitas_Ubi_Kayu = mape_garch_ptj,
  ...
  data.frame(
    Metric = "RMSE",
    Produktivitas_Ubi_Kayu = rmse_garch_ptj,
  ...
  data.frame(
    Metric = "MAE",
    Produktivitas_Ubi_Kayu = mae_garch_ptj,
  ...
  data.frame(
    Metric = "MSE",
    Produktivitas_Ubi_Kayu = mse_garch_ptj,
