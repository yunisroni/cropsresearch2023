...
plot_palawija1 <- ggplot(totproduksi_palawija, aes(x = Tahun, y = total_produksi, color = Provinsi)) +
  geom_line() +
  geom_point() +
  labs(title = "Tren Produksi Palawija", x = "Tahun", y = "Total Produksi (Ton)") +
...
*kesimpulan*
Berdasarkan hasil uji Granger Causality, tidak terdapat bukti yang cukup untuk menyatakan bahwa avg_rainfall secara signifikan menyebabkan Granger untuk Produksi dan Produktivitas.
...
## c.VAR terhadap Produksi Kacang Hijau Sumatera
...
## Interpretasi
Terdapat pengaruh avg_rainfall terhadap produksi dan produktivitasBerdasarkan hasil analisis dengan model VAR, analisis kausalitas, dan regresi linear ini:
